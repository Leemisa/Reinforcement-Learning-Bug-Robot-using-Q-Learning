...
EXPERIMENT_NAME = "Experiment 3A - Pure Q-Learning + Distance Goal"
CSV_FILE = "experiment_data.csv"   # ← Paste your robot's CSV output here!
...
ax1 = plt.subplot(2, 2, 1 if has_distance else 1)
...
ax3 = plt.subplot(2, 2, 3 if has_distance else 2)
window = 3
if len(df) > window:
...
# === 4. Final Summary ===
ax4 = plt.subplot(2, 2, 4 if has_distance else None)
plt.axis('off')
